...
import site.lbw.exception.NotFoundException;
...
import site.lbw.task.RedisSyncScheduleTask;
...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public List<site.lbw.entity.Blog> getListByTitleAndCategoryId(String title, Integer categoryId) {
	...
	@Override
	public List<site.lbw.entity.Blog> getIdAndTitleList() {
	...
	@Override
	public site.lbw.entity.Blog getBlogById(Long id) {
		site.lbw.entity.Blog blog = blogMapper.getBlogById(id);
		if (blog == null) {
