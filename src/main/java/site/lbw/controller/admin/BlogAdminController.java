...
public class BlogAdminController {
    ...
    public Result blogs(@RequestParam(defaultValue = "") String title,
        ...
        PageInfo<site.lbw.entity.Blog> pageInfo =
				new PageInfo<>(blogService.getListByTitleAndCategoryId(title, categoryId));
    ...
    public Result updateVisibility(@PathVariable Long id,
								   @RequestBody BlogVisibility blogVisibility) {
    ...
    public Result getBlog(@RequestParam Long id) {
        site.lbw.entity.Blog blog = blogService.getBlogById(id);
