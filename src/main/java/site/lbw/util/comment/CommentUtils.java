package site.lbw.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import site.lbw.constant.PageConstants;
import site.lbw.constant.RedisKeyConstants;
import site.lbw.entity.Comment;
import site.lbw.entity.User;
import site.lbw.service.*;
import site.lbw.util.comment.channel.ChannelFactory;
import site.lbw.util.comment.channel.CommentNotifyChannel;
import site.lbw.config.properties.BlogProperties;
import site.lbw.model.vo.FriendInfo;
import site.lbw.service.*;
import site.lbw.util.HashUtils;
import site.lbw.util.IpAddressUtils;
import site.lbw.util.MailUtils;
import site.lbw.util.QQInfoUtils;
import site.lbw.util.StringUtils;
import site.lbw.enums.CommentOpenStateEnum;
import site.lbw.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(site.lbw.model.dto.Comment comment, boolean isVisitorComment, Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(Comment parentComment, site.lbw.model.dto.Comment comment) {
	 ...
	 * @param comment 当前收到的评论
	 */
	private void notifyMyself(site.lbw.model.dto.Comment comment) {
	 ...
	 */
	public static CommentPageEnum getCommentPageEnum(site.lbw.model.dto.Comment comment) {
	 ...
	 * @param comment 当前收到的评论
	 */
	private void setCommentRandomAvatar(site.lbw.model.dto.Comment comment) {
		//设置随机头像
	 ...
	 * @param admin   博主信息
	 */
	private void setGeneralAdminComment(site.lbw.model.dto.Comment comment, User admin) {
	 ...
	 * @param comment 评论DTO
	 */
	public void setAdminCommentByTelegramAction(site.lbw.model.dto.Comment comment) {
	 ...
	 * @param admin   博主信息
	 */
	public void setAdminComment(site.lbw.model.dto.Comment comment, HttpServletRequest request, User admin) {
		setGeneralAdminComment(comment, admin);
	 ...
	 * @param request 用于获取ip
	 */
	public void setVisitorComment(site.lbw.model.dto.Comment comment, HttpServletRequest request) {
