...
import site.lbw.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		site.lbw.entity.ScheduleJob scheduleJob = (site.lbw.entity.ScheduleJob) context.getMergedJobDataMap().get(site.lbw.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
